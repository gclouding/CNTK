...
CNTKLIBRARY_CIFAR_TESTS_SRC =\
	$(CNTKLIBRARY_CIFAR_TESTS_SRC_PATH)/Main.cpp \
	$(CNTKLIBRARY_CIFAR_TESTS_SRC_PATH)/../Common/Common.cpp \
	$(CNTKLIBRARY_CIFAR_TESTS_SRC_PATH)/CifarResNet.cpp \

CNTKLIBRARY_CIFAR_TESTS:=$(BINDIR)/cifarresnettests
CNTKLIBRARY_CIFAR_TESTS_OBJ := $(patsubst %.cu, $(OBJDIR)/%.o, $(patsubst %.cpp, $(OBJDIR)/%.o, $(CNTKLIBRARY_CIFAR_TESTS_SRC)))

ALL+=$(CNTKLIBRARY_CIFAR_TESTS)
SRC+=$(CNTKLIBRARY_CIFAR_TESTS_SRC)

$(CNTKLIBRARY_CIFAR_TESTS): $(CNTKLIBRARY_CIFAR_TESTS_OBJ) | $(CNTKLIBRARY_LIB) $(READER_LIBS)
	@echo $(SEPARATOR)
	@mkdir -p $(dir $@)
	@echo building $@ for $(ARCH) with build type $(BUILDTYPE)
	$(CXX) $(LDFLAGS) $(patsubst %,-L%, $(LIBDIR) $(LIBPATH) $(GDK_NVML_LIB_PATH)) $(patsubst %,$(RPATH)%, $(ORIGINLIBDIR) $(LIBPATH)) -o $@ $^ $(LIBS) -l$(CNTKLIBRARY) $(L_READER_LIBS)
...
########################################
# V2Library LSTMSequenceClassifierTests
########################################

CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC_PATH =\
    $(CNTKLIBRARY_END_TO_END_TESTS_SRC_PATH)/LSTMSequenceClassifier

CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC =\
	$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC_PATH)/Main.cpp \
	$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC_PATH)/../Common/Common.cpp \
	$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC_PATH)/SequenceClassification.cpp \

CNTKLIBRARY_LSTM_SEQUENCE_TESTS:=$(BINDIR)/lstmsequenceclassifiertests
CNTKLIBRARY_LSTM_SEQUENCE_TESTS_OBJ := $(patsubst %.cu, $(OBJDIR)/%.o, $(patsubst %.cpp, $(OBJDIR)/%.o, $(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC)))

ALL+=$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS)
SRC+=$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_SRC)

$(CNTKLIBRARY_LSTM_SEQUENCE_TESTS): $(CNTKLIBRARY_LSTM_SEQUENCE_TESTS_OBJ) | $(CNTKLIBRARY_LIB) $(READER_LIBS)
	@echo $(SEPARATOR)
	@mkdir -p $(dir $@)
	@echo building $@ for $(ARCH) with build type $(BUILDTYPE)
	$(CXX) $(LDFLAGS) $(patsubst %,-L%, $(LIBDIR) $(LIBPATH) $(GDK_NVML_LIB_PATH)) $(patsubst %,$(RPATH)%, $(ORIGINLIBDIR) $(LIBPATH)) -o $@ $^ $(LIBS) -l$(CNTKLIBRARY) $(L_READER_LIBS)
...
########################################
# V2Library MNISTClassifierTests
########################################

CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC_PATH =\
    $(CNTKLIBRARY_END_TO_END_TESTS_SRC_PATH)/MNISTClassifier

CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC =\
	$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC_PATH)/Main.cpp \
	$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC_PATH)/../Common/Common.cpp \
	$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC_PATH)/TrainerTests.cpp \

CNTKLIBRARY_MNIST_CLASSIFIER_TESTS:=$(BINDIR)/mnistclassifiertests
CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_OBJ := $(patsubst %.cu, $(OBJDIR)/%.o, $(patsubst %.cpp, $(OBJDIR)/%.o, $(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC)))

ALL+=$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS)
SRC+=$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_SRC)

$(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS): $(CNTKLIBRARY_MNIST_CLASSIFIER_TESTS_OBJ) | $(CNTKLIBRARY_LIB) $(READER_LIBS)
	@echo $(SEPARATOR)
	@mkdir -p $(dir $@)
	@echo building $@ for $(ARCH) with build type $(BUILDTYPE)
	$(CXX) $(LDFLAGS) $(patsubst %,-L%, $(LIBDIR) $(LIBPATH) $(GDK_NVML_LIB_PATH)) $(patsubst %,$(RPATH)%, $(ORIGINLIBDIR) $(LIBPATH)) -o $@ $^ $(LIBS) -l$(CNTKLIBRARY) $(L_READER_LIBS)
...
########################################
# V2Library SequenceToSequenceTests
########################################

CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC_PATH =\
    $(CNTKLIBRARY_END_TO_END_TESTS_SRC_PATH)/SequenceToSequenceTranslator

CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC =\
	$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC_PATH)/Main.cpp \
	$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC_PATH)/../Common/Common.cpp \
	$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC_PATH)/Seq2Seq.cpp \

CNTKLIBRARY_SEQ_TO_SEQ_TESTS:=$(BINDIR)/sequencetosequencetests
CNTKLIBRARY_SEQ_TO_SEQ_TESTS_OBJ := $(patsubst %.cu, $(OBJDIR)/%.o, $(patsubst %.cpp, $(OBJDIR)/%.o, $(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC)))

ALL+=$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS)
SRC+=$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_SRC)

$(CNTKLIBRARY_SEQ_TO_SEQ_TESTS): $(CNTKLIBRARY_SEQ_TO_SEQ_TESTS_OBJ) | $(CNTKLIBRARY_LIB) $(READER_LIBS)
	@echo $(SEPARATOR)
	@mkdir -p $(dir $@)
	@echo building $@ for $(ARCH) with build type $(BUILDTYPE)
	$(CXX) $(LDFLAGS) $(patsubst %,-L%, $(LIBDIR) $(LIBPATH) $(GDK_NVML_LIB_PATH)) $(patsubst %,$(RPATH)%, $(ORIGINLIBDIR) $(LIBPATH)) -o $@ $^ $(LIBS) -l$(CNTKLIBRARY) $(L_READER_LIBS)
...
###########################################
# V2Library TruncatedLSTMAcousticModelTests
###########################################

CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC_PATH =\
    $(CNTKLIBRARY_END_TO_END_TESTS_SRC_PATH)/TruncatedLSTMAcousticModel

CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC =\
	$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC_PATH)/Main.cpp \
	$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC_PATH)/../Common/Common.cpp \
	$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC_PATH)/TruncatedLSTMAcousticModel.cpp \

CNTKLIBRARY_TRUNCATED_LSTM_TESTS:=$(BINDIR)/truncatedlstmacousticmodeltests
CNTKLIBRARY_TRUNCATED_LSTM_TESTS_OBJ := $(patsubst %.cu, $(OBJDIR)/%.o, $(patsubst %.cpp, $(OBJDIR)/%.o, $(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC)))

ALL+=$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS)
SRC+=$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_SRC)

$(CNTKLIBRARY_TRUNCATED_LSTM_TESTS): $(CNTKLIBRARY_TRUNCATED_LSTM_TESTS_OBJ) | $(CNTKLIBRARY_LIB) $(READER_LIBS)
	@echo $(SEPARATOR)
	@mkdir -p $(dir $@)
	@echo building $@ for $(ARCH) with build type $(BUILDTYPE)
	$(CXX) $(LDFLAGS) $(patsubst %,-L%, $(LIBDIR) $(LIBPATH) $(GDK_NVML_LIB_PATH)) $(patsubst %,$(RPATH)%, $(ORIGINLIBDIR) $(LIBPATH)) -o $@ $^ $(LIBS) -l$(CNTKLIBRARY) $(L_READER_LIBS)
